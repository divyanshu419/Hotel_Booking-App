...
const AllRooms = () => {
  ...
  return (
    <div className='flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-32 md:px-16 px-4 lg:px-24'>
      ...
      <div>
        ...
        <div className='flex flex-col items-start text-left'>
          ...
          <p className='text-sm md:text-base text-gray-500/90 mt-2'>
            Take advantages of our limited-time offers and special packages to enhance your stay and creates unforgettable memories.
          </p>
          {roomsDummyData.map((room) => (
            <div key={room._id} className='flex flex-col items-center md:flex-row py-10 gap-6 border-b border-gray-300 last:pb-30 last:border-0 '>
              ...
              <div className='md:w-1/2 flex flex-col gap-2'>
                ...
                <div className='flex flex-wrap items-center mt-3 mb-6 gap-4 cursor-pointer'>
      ...
      <div className=' bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-10 mt-16 ml-34'>
        <div>
